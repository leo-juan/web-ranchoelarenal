        ...
        <div class="col-md-offset-1 col-md-10">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body ">
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Salario diario'); ?></label>

                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="day_salary"
                                id="day_salary" value="<?php echo $row['day_salary']; ?>" readonly />
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Horas laboradas'); ?></label>

                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="working_hour"
                                id="working_hour" value="<?php echo $row['horas_trabajadas']; ?>" readonly />
                        </div>
                    </div>
