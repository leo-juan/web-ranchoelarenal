...
<div class="form-group">
    ...
    <div class="col-sm-5">                                                                 
        <input type="t" class="form-control" name="joining_salary" value="<?php echo $row['joining_salary']; ?>" >
    </div>
</div>
...
<div class="form-group">                                                     <!-- texto del label de formulario -->
    <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Horario asiganado'); ?></label>

    <div class="col-sm-5">        <!-- nombre de la tabla donde gaurdara -->      <!-- nombre de la tablapara que jale el horario --> 
