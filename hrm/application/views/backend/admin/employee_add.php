...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control datepicker" name="date_of_birth" value="" data-start-view="2" placeholder="date here" data-format="D, dd MM yyyy" required />
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('Horarios'); ?></label>

            <div class="col-sm-5">
                <select class="form-control selectboxit" name="horario" value="" required>
                    <option value=""><?php echo get_phrase('Seleciona un horario'); ?></option>
                    <?php
                    $horarios = $this->db->get('schedules')->result_array();
                    foreach ($horarios as $row) : ?>

                        <option value="<?php echo $row['time_in'] . ' - ' . $row['time_out']; ?>">
                            <?php echo $row['time_in'] . ' - ' . get_phrase(''); ?>
                            <?php echo $row['time_out'] . '' . get_phrase(''); ?>
                        </option>
