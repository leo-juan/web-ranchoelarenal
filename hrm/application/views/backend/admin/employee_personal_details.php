...
<div class="form-group">
    <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Hora de entrada'); ?></label>

    <div class="col-sm-5">
        <input type="time" class="form-control" name="check_time" value="" >
    </div>
</div>

<div class="form-group">
    <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Hora de salida'); ?></label>
