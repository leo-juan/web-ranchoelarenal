            ...
            <div class="panel panel-default" >
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Año fiscal'); ?></label>

                    <div class="col-sm-9">

                       <select name="año_fiscal" class="form-control selectboxit">
                        <option value="año_fiscal_1"><?php echo get_phrase('360 días'); ?></option>
                        <option value="año_fiscal_2"><?php echo get_phrase('365 días'); ?></option>
                                <?php
                  foreach ($fields as $field) {

                    if ($field == 'phrase_id' || $field == 'phrase')continue;
                    $año_fiscal = $this->db->get_where('settings' , array('type'=>'año_fiscal'))->row()->description;?>

                    <option value="<?php echo $field;?>"
                    <?php if ($año_fiscal == $field)echo 'selected';?>> <?php echo $field;?> </option><?php
                  }
                  ?>
                </select>
              </div>
